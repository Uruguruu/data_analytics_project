...
public class MainController {
	 ...
	 */
	@PutMapping("/product")
		public String editProduct(@RequestParam(value = "product_id") Integer product_id, @RequestParam(value = "product_name") String product_name, @RequestParam(value = "amount") Integer amount)  {
